...
- [ ] Explain the difference between `Relational Databases` and `SQL`.
  ...
  Relational databases store data and SQL is the language we use to interact with/manipulate that data

- [ ] Why do tables need a `primary key`?

  Tables require a primary key to act as a unique identifier for the data on that table
...
- [ ] What do we need in order to have a _many to many_ relationship between two tables.
    ...
    A third table that links the first two tables
